...
export cont_ai=`ls -l /userdata/system/.config/retroarch/snes9x181/*.so |wc -l`

cd /userdata/system/.config/retroarch/snes9x181
	...
	exit 0
        ...
        for file in *.so; do 
             ...
             then
                 ...
                 cp /userdata/system/.config/retroarch/snes9x181/$file /usr/lib/libretro/$file
             else
