...
export cont_ai=`ls -l /userdata/system/.config/retroarch/fbneo711/*.so |wc -l`

cd /userdata/system/.config/retroarch/fbneo711
	...
	exit 0
        ...
        for file in *.so; do 
             ...
             then
                 ...
                 cp /userdata/system/.config/retroarch/fbneo711/$file /usr/lib/libretro/$file
             else
