...
export cont_ai=`ls -l /userdata/system/.config/retroarch/fbneobt529/*.so |wc -l`

cd /userdata/system/.config/retroarch/fbneobt529
	...
	exit 0
        ...
        for file in *.so; do 
             ...
             then
                 ...
                 cp /userdata/system/.config/retroarch/fbneobt529/$file /usr/lib/libretro/$file
             else
